...
namespace AxGrid.Utils {
  ...
  public delegate double DEasingMethodD(double t, double b, double c, double d);
  public delegate float DEasingMethodF(float t, float b, float c, float d);
  ...
  public class Easing {
    ...
    public static float CircEaseInOut(float t, float b, float c, float d) {
      ...
      return (float) ((double) c / 2.0 * ((double) Mathf.Sqrt((float) (1.0 - (double) (t -= 2f) * (double) t)) + 1.0)) +
             b;
    }
    ...
    public static float SineEaseInOut(float t, float b, float c, float d) {
      ...
      return (float) (-(double) c / 2.0 * ((double) Mathf.Cos((float) (3.14159274101257 * (double) --t / 2.0)) - 2.0)) +
             b;
    }
    ...
    public static float QuartEaseOut(float t, float b, float c, float d) {
      return (float) (-(double) c *
                      ((double) (t = (float) ((double) t / (double) d - 1.0)) * (double) t * (double) t * (double) t -
                       1.0)) + b;
    }
    ...
    public static float QuintEaseOut(float t, float b, float c, float d) {
      return c * (float) ((double) (t = (float) ((double) t / (double) d - 1.0)) * (double) t * (double) t *
                          (double) t * (double) t + 1.0) + b;
    }
    ...
    public static float QuintEaseInOut(float t, float b, float c, float d) {
      ...
      return (float) ((double) c / 2.0 *
                      ((double) (t -= 2f) * (double) t * (double) t * (double) t * (double) t + 2.0)) + b;
    }
    ...
    public static float ElasticEaseOut(float t, float b, float c, float d) {
      ...
      return c * Mathf.Pow(2f, -10f * t) *
             Mathf.Sin((float) (((double) t * (double) d - (double) num2) * 6.28318548202515) / num1) + c + b;
    }
    ...
    public static float ElasticEaseIn(float t, float b, float c, float d) {
      ...
      float num1 = d * 0.3f;
      float num2 = num1 / 4f;
      return (float) -((double) c * (double) Mathf.Pow(2f, 10f * --t) *
                       (double) Mathf.Sin((float) (((double) t * (double) d - (double) num2) * 6.28318548202515) /
                                          num1)) + b;
    }
    ...
    public static float ElasticEaseInOut(float t, float b, float c, float d) {
      ...
      float num2 = num1 / 4f;
      if ((double) t < 1.0)
        return (float) (-0.5 * ((double) c * (double) Mathf.Pow(2f, 10f * --t) *
                                (double) Mathf.Sin(
                                  (float) (((double) t * (double) d - (double) num2) * 6.28318548202515) / num1))) + b;
      return (float) ((double) c * (double) Mathf.Pow(2f, -10f * --t) *
                      (double) Mathf.Sin((float) (((double) t * (double) d - (double) num2) * 6.28318548202515) /
                                         num1) * 0.5) + c + b;
    }
    ...
    public static float BackEaseOut(float t, float b, float c, float d) {
      return c * (float) ((double) (t = (float) ((double) t / (double) d - 1.0)) * (double) t *
                          (2.70158004760742 * (double) t + 1.70158004760742) + 1.0) + b;
    }

    public static float BackEaseIn(float t, float b, float c, float d) {
      return (float) ((double) c * (double) (t /= d) * (double) t *
                      (2.70158004760742 * (double) t - 1.70158004760742)) + b;
    }
    ...
    public static float BackEaseInOut(float t, float b, float c, float d) {
      ...
      if ((double) (t /= d / 2f) < 1.0) {
        float num2;
        return (float) ((double) c / 2.0 * ((double) t * (double) t *
                                            (((double) (num2 = num1 * 1.525f) + 1.0) * (double) t - (double) num2))) +
               b;
      }

      float num3;
      return (float) ((double) c / 2.0 * ((double) (t -= 2f) * (double) t *
                                          (((double) (num3 = num1 * 1.525f) + 1.0) * (double) t + (double) num3) +
                                          2.0)) + b;
    }
    ...
    public static float FeedbackEaseOut(float t, float b, float c, float d, float tl, int fs) {
      ...
      t -= d;
      t /= tl / 1.2f;
      return (float) ((double) b + (double) c -
                      2.0 * (double) Mathf.Cos(t * 3f) / (10.0 * (double) t + 2.0) * (double) fs);
    }
  }
